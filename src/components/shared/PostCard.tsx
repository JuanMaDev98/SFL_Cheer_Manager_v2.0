  ...
  return (
    ...
    >
      <CardContent className="p-0 gap-0 flex flex-col">
        {/* Top row: avatar + nickname + farmId (left) | badges + counter (right) */}
        ...
        {/* Title */}
        <h3 className="text-sm font-bold text-green-900 leading-tight line-clamp-2 px-2">
          {post.title}
        </h3>
